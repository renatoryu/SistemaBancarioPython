...
Este é um projeto de sistema bancário simples desenvolvido em Python em Colaboração a [DIO](https://www.dio.me/). O sistema permite realizar operações bancárias básicas, depositar, sacar e consultar extrato.
